        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-12">
          ...
          <div>
            ...
            <div className=" flex gap-2 mb-12">
              <button
                onClick={() =>
                  window.open("https://wa.me/971581425513", "_blank")
                }
                className="relative flex items-center gap-2 px-3 py-2 font-medium text-white bg-green-500 rounded-lg shadow-lg transition-all duration-300 ease-in-out overflow-hidden group hover:scale-105 hover:shadow-2xl hover:bg-green-700 text-nowrap"
              >
                {/* Floating Effect */}
              ...
              <button className="relative flex items-center gap-2 px-3 py-2 font-medium text-nowrap text-white bg-[#DC893F] rounded-lg shadow-lg transition-all duration-300 ease-in-out overflow-hidden group hover:scale-105 hover:shadow-2xl hover:bg-[#FF8800]">
                {/* Floating Effect */}
                <span className="absolute top-0 left-0 w-2 h-2 bg-white rounded-full opacity-0 group-hover:opacity-100 group-hover:w-4 group-hover:h-4 transition-all duration-500 ease-in-out"></span>
